...
function Doctors() {
    ...
    const filteredDoctors = useMemo(() => {
        ...
        const filtered = doctors.filter((doctor) => {
            ...
            const matchesStatus =
                status === "all" ||
                doctor.status?.toLowerCase() === status.toLowerCase();

            const matchesJoiningDate =
                !joiningDate ||
                formatDateForInput(doctor.joiningDate) === joiningDate;
        ...
        <div className="doctors-page">
                ...
                <div className="doctors-table-wrapper">
                    <table className="doctors-table">
                        ...
                        <tbody>
                            {loading ? (
                                <tr>
                                    <td colSpan="14" className="table-message">
                                        Loading doctors...
                                    </td>
                                </tr>
                                ...
                                paginatedDoctors.map((doctor) => (
                                    <tr key={doctor._id}>
                                        ...
                                        <td>{formatDate(doctor.joiningDate)}</td>
                                        <td>
                                            <span
            ...
            <div className="doctors-pagination">
                <div className="pagination-result">
                    Showing {totalDoctors === 0 ? 0 : startIndex + 1} to {endIndex} of {totalDoctors} doctors
                </div>
                    ...
                    <div className="doctor-modal">
                        <div className="doctor-modal-header">
                            <div>
                                ...
                                <p>
                                    Enter the doctor's professional and account
                                    information.
                                </p>
                            </div>
                                ...
                                <div className="form-section">
                                    ...
                                    <div className="form-grid">
                                        ...
                                        <div className="form-group form-group-full">
                                            ...
                                            />
                                            <small>
                                                This password will be sent to the
                                                doctor's email.
                                            </small>
                                        </div>
                                    </div>
